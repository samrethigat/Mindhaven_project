  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <Empty title="No conversations" description="Chat is enabled once a counselor confirms your appointment." />
      ) : (
        <div className="grid gap-4 md:grid-cols-[300px_1fr]">
          {/* Mobile: list first, then chat */}
